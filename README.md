...
Source for [kunalkhosla.github.io/blogs](https://kunalkhosla.github.io/blogs).

Jekyll + Minima. Posts live in `_posts/`. Code for each post lives in its own dedicated repo and is linked from the post.

## Posts

- [Buying streams, not software](_posts/2026-05-09-iptv-webui-why.md) — companion repo: [iptv-webui](https://github.com/kunalkhosla/iptv-webui).
